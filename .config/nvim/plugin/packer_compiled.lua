...
_G.packer_plugins = {
  ...
  colorschemes = {
    loaded = true,
    path = "/home/admin/.local/share/nvim/site/pack/packer/start/colorschemes",
    url = "https://github.com/lunarvim/colorschemes"
  },
  ["feline.nvim"] = {
    loaded = true,
    path = "/home/admin/.local/share/nvim/site/pack/packer/start/feline.nvim",
  ...
  ["onedarker.nvim"] = {
    loaded = true,
    path = "/home/admin/.local/share/nvim/site/pack/packer/start/onedarker.nvim",
